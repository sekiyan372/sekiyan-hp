...
const links = [
  {
    ...
    icon: (
      <BsTwitter className="w-12 h-12 text-neutral-600 cursor-pointer hover:opacity-70" />
    ),
  },
  {
    name: 'Instagram',
    ...
    icon: (
      <BsInstagram className="w-12 h-12 text-neutral-600 cursor-pointer hover:opacity-70" />
    ),
  },
  {
    name: 'Youtube',
    ...
    icon: (
      <BsYoutube className="w-12 h-12 text-neutral-600 cursor-pointer hover:opacity-70" />
    ),
  },
  {
    name: 'Blog',
    ...
    icon: (
      <BsFillPenFill className="w-12 h-12 text-neutral-600 cursor-pointer hover:opacity-70" />
    ),
  },
  {
    name: 'Github',
    ...
    icon: (
      <BsGithub className="w-12 h-12 text-neutral-600 cursor-pointer hover:opacity-70" />
    ),
  },
]
